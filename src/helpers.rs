...
impl Highlighter
{
    ...
    pub fn highlight<'a>(&self, tab: &Tab) -> Vec<ratatui::text::Line<'a>>
    {
        ...
        let syntax = self.syntax_set
            ...
            .ok()
            .flatten().unwrap_or_else(|| self.syntax_set.find_syntax_plain_text());
        ...
        {
            let range = the_highlighter.highlight_line(line, &self.syntax_set).unwrap_or_default();
